class CurrencyPlayerDialog
{
	...
	class controlsBackground {
		class CurrencyTitleBackground:ACD_RscText {
		...
		class CurrencyMainBackground:ACD_RscText {
	...
	class Controls {
		...
		class CurrencyAmountEdit : ACD_RscEdit {
		...
		class CurrencyTitleText : ACD_RscTitle {
		...
		class CurrencyAddCashButton : ACD_RscButtonMenu 
		{
			idc = -1;
			text = "Add cash";
		...
		class CurrencyAddBankButton : ACD_RscButtonMenu 
		{
			idc = -1;
			text = "Add bank";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
		...
		class CurrencyRemoveCashButton : ACD_RscButtonMenu 
		{
			idc = -1;
			text = "Remove cash";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
		...
		class CurrencyRemoveBankButton : ACD_RscButtonMenu 
		{
			idc = -1;
			text = "Remove bank";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
		...
		class CurrencyCloseButton : ACD_RscButtonMenu {
			idc = -1;
			text = "Close";
