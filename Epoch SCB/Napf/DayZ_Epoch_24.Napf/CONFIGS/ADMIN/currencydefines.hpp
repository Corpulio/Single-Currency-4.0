...
class ACD_RscControlsGroup {
	...
	class VScrollBar : ACD_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};

	class HScrollBar : ACD_RscScrollBar
	{
		height = 0.028;
	};
...
class ACD_RscControlsGroupNoScrollbars : ACD_RscControlsGroup {
...
class ACD_RscListNBox
{
	...
	period = 1.2;
	class ListScrollBar: ACD_RscScrollBar{};
	class ScrollBar: ACD_RscScrollBar{};
};
...
class ACD_RscTitle : ACD_RscText {
	style = 0;
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {0.95, 0.95, 0.95, 1};
};

class ACD_RscPicture {
	shadow = 0;
	type = 0;
	style = 48;
	sizeEx = 0.023;
...
class ACD_RscTextMulti : ACD_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class ACD_RscPictureKeepAspect : ACD_RscPicture 
{
	style = 0x30 + 0x800;
};

class ACD_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class ACD_RscButtonTextOnly : ACD_RscButton {
	SizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class ACD_RscButtonMenu : ACD_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class ACD_RscShortcutButtonMain : ACD_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class ACD_RscBackground : ACD_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class ACD_RscCombo {
	...
	font = "Zeppelin32";
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	class ComboScrollBar : ACD_RscScrollBar {};
};

class ACD_RscToolbox {
	colorText[] = {0.95, 0.95, 0.95, 1};
	color[] = {0.95, 0.95, 0.95, 1};
